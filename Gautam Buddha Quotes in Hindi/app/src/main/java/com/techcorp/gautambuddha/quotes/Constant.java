package com.techcorp.gautambuddha.quotes;
...
public class Constant {
    ...
    public static final String notification_name = "GautamBuddhaQuotes_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_GautamBuddhaQuotes";


    public static final String SHARED_PREF = "ah_firebase_GautamBuddhaQuotes";
