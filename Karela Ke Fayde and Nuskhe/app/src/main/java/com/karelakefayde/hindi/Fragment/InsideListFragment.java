...
import com.karelakefayde.hindi.Adapter.MainItemAdapter;
import com.karelakefayde.hindi.ConnectionDetector;
import com.karelakefayde.hindi.Constant;
import com.karelakefayde.hindi.EndlessRecyclerOnScrollListener;
import com.karelakefayde.hindi.R;
import com.karelakefayde.hindi.gettersetter.ItemImageData;
 ...
 */
public class InsideListFragment extends Fragment implements MainItemAdapter.MyClickListener, Constant.Callingafterads {
    ...
    public void onItemClick(int position, Item_images getarray, View v) {
        ...
        PassingTitle = getarray.getItem_title() + "";
