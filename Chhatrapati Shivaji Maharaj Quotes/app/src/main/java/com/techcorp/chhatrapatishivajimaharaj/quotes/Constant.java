...
public class Constant {
    ...
    public static final String notification_name = "ChhatrapatiShivajiMaharaj_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_ChhatrapatiShivajiMaharaj";


    public static final String SHARED_PREF = "ah_firebase_ChhatrapatiShivajiMaharaj";
