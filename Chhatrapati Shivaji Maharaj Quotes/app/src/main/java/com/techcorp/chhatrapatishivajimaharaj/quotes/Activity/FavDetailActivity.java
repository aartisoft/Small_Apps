package com.techcorp.chhatrapatishivajimaharaj.quotes.Activity;
...
import com.techcorp.chhatrapatishivajimaharaj.quotes.ConnectionDetector;
import com.techcorp.chhatrapatishivajimaharaj.quotes.Constant;
import com.techcorp.chhatrapatishivajimaharaj.quotes.DbAdapter;
import com.techcorp.chhatrapatishivajimaharaj.quotes.PrefManager;
import com.techcorp.chhatrapatishivajimaharaj.quotes.R;
import com.techcorp.chhatrapatishivajimaharaj.quotes.gettersetter.ItemUpdate;
import com.techcorp.chhatrapatishivajimaharaj.quotes.gettersetter.Item_images;
import com.techcorp.chhatrapatishivajimaharaj.quotes.widgets.CircleImageView;
...
import static com.techcorp.chhatrapatishivajimaharaj.quotes.Constant.show_app_icon;
...
public class FavDetailActivity extends AppCompatActivity {
    ...
    public void ActionShareclick() {
        constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl, "Processing");
        String finalString = "";
        String ShareString = "";
        ...
        if (ActionTypepass.equals(WHATSAPP_ID)) {
            ...
            constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl, "Something Went Wrong! Try Again");
        }
    ...
    private void showData() {
        ...
        try {
            Glide.with(FavDetailActivity.this).load(Itemdata.getCategory_image()).placeholder(R.drawable.bg_transparant).into(detail_image);
            if (!show_app_icon && Itemdata.getImage_thumb() != null && !Itemdata.getImage_thumb().equals("")){
                Glide.with(FavDetailActivity.this).load(Itemdata.getImage_thumb()).placeholder(R.drawable.bg_transparant).into(detail_image);
            }
    ...
    public void sharewhatsapp(String finaldata) {
        ...
        try {
            ...
            constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl, "Whatsapp have not been installed");
        }
    }
    ...
    public void copytext(String finaldata) {
        try {
            ...
            constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl, "Text Copied Successfully!");
        } catch (Exception e) {
            constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl, "Something Went Wrong! Try Again");
        }
    ...
    public void actionfavourite() {
        String uniqueid = Itemdata.getId();
        if(db.isExist(uniqueid)){
            db.delete(uniqueid);
            onBackPressed();
        }else{
            constantfile.snackbarcommonview(FavDetailActivity.this, detail_rl,  "No Image Found!");
        }
    }
    ...
    public void AppExit() {
        AlertDialog.Builder exitDialog = new AlertDialog.Builder(FavDetailActivity.this);
