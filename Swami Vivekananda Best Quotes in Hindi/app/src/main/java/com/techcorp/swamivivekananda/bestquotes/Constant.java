package com.techcorp.swamivivekananda.bestquotes;
...
public class Constant {
    ...
    public static final String notification_name = "SwamiVivekanandaBestQuotes_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_SwamiVivekanandaBestQuotes";


    public static final String SHARED_PREF = "ah_firebase_SwamiVivekanandaBestQuotes";
