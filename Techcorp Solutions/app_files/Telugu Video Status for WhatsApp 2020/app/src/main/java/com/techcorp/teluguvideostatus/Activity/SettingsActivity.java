...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void initAction() {
        ...
        this.switch_button_notification.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b==true){
                    prf.setBoolean(Constant.SHARED_NOTIFICATION_SET,true);
                }else{
                    prf.setBoolean(Constant.SHARED_NOTIFICATION_SET,false);
                }
            }
        });
        this.switch_button_autoplay.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b==true){
                    prf.setBoolean(Constant.SHARED_AUTOPLAY_SET,true);
                }else{
                    prf.setBoolean(Constant.SHARED_AUTOPLAY_SET,false);
                }
            }
        });
        ...
        this.notification_rl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!prf.getBooleannotification(Constant.SHARED_NOTIFICATION_SET)){
                    prf.setBoolean(Constant.SHARED_NOTIFICATION_SET,true);
        ...
        this.autoplay_rl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!prf.getBoolean(Constant.SHARED_AUTOPLAY_SET)){
                    prf.setBoolean(Constant.SHARED_AUTOPLAY_SET,true);
    ...
    public void send_feedback() {
        ...
        constantfile.snackbarcommonview(SettingsActivity.this, relative_setting, "Processing");
        ...
        try {
            ...
            constantfile.snackbarcommonview(SettingsActivity.this, relative_setting, "There are no email clients installed.");
        }
