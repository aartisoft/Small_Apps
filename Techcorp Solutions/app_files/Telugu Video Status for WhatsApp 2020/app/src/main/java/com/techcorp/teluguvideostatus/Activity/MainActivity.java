package com.techcorp.teluguvideostatus.Activity;
...
import com.techcorp.teluguvideostatus.Fragment.DownloadFragment;
import com.techcorp.teluguvideostatus.Fragment.HomeFragment;
import com.techcorp.teluguvideostatus.PrefManager;
import com.loopj.android.http.AsyncHttpClient;
import com.loopj.android.http.JsonHttpResponseHandler;
import com.loopj.android.http.RequestParams;
import com.techcorp.teluguvideostatus.Constant;
import com.techcorp.teluguvideostatus.Fragment.PrivacyPolicyFragment;
import com.techcorp.teluguvideostatus.R;
import com.techcorp.teluguvideostatus.gettersetter.ItemUpdate;
...
//        }
        ...
        if (pref.getString(Constant.SHARED_Token) != null && !pref.getString(Constant.SHARED_Token).equals("")) {
            String regId = pref.getString(Constant.SHARED_Token);
            CallAddToken(regId);
        } else {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            changefragment = true;
            fragmentposition = 1;
            title_text = getResources().getString(R.string.title_download);
    ...
    public void getopenPrivacypolicy() {
        String url = "https://techcorpsolutions.blogspot.com/2020/03/video-status-app-policy.html";
    ...
    public void send_feedback() {
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"bhautik84604563@gmail.com"});
        i.putExtra(Intent.EXTRA_SUBJECT, getResources().getString(R.string.app_name));
        i.putExtra(Intent.EXTRA_TEXT   , "");
        try {
            startActivity(Intent.createChooser(i, "Send mail..."));
        } catch (android.content.ActivityNotFoundException ex) {
            constantfile.snackbarcommonview(MainActivity.this, drawer_layout, "There are no email clients installed.");
        }
        ...
        public void onSuccess(int i, Header[] headers, JSONObject bytes) {
            try {
                ...
                if (statusData.isStatus()) {
                    pref.setString(Constant.SHARED_Token,getToken);
                } else {
    ...
    public void Callforeupdate() throws PackageManager.NameNotFoundException {
        ...
        client.get(Constant.GET_foreceupdate, params, new Asynchronouseforeceupdate());
    }


    class Asynchronouseforeceupdate extends JsonHttpResponseHandler {


        Asynchronouseforeceupdate() {
        }
    ...
    public void updatedialogshow(){
        ...
        View promptView1 = inflater.inflate(R.layout.alert_update, null);
        ...
        TextView bt_yes = (TextView) promptView1.findViewById(R.id.bt_yes);
