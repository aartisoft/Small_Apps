...
public class Constant {
    ...
    public static final String notification_name = "RabindranathTagorePoems_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_RabindranathTagorePoems";


    public static final String SHARED_PREF = "ah_firebase_RabindranathTagorePoems";
