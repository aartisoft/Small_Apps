package com.techcorp.babasaheb.ambedkarquotes.inhindi;
...
public class Constant {
    ...
    public static final String notification_name = "BabaSahebAmbedkarQuotes_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_BabaSahebAmbedkarQuotes";


    public static final String SHARED_PREF = "ah_firebase_BabaSahebAmbedkarQuotes";
