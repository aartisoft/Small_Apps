package com.techcorp.abdulkalam.quotesinhindi;
...
public class Constant {
    ...
    public static final String notification_name = "AbdulKalamMotivational_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_AbdulKalamMotivational";


    public static final String SHARED_PREF = "ah_firebase_AbdulKalamMotivational";
