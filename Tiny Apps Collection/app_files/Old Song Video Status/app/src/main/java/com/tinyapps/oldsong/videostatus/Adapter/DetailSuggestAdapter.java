package com.tinyapps.oldsong.videostatus.Adapter;
...
public class DetailSuggestAdapter extends RecyclerView.Adapter<DetailSuggestAdapter.DataObjectHolder> {

    ArrayList<Item_collections> mRecyclerViewItems = new ArrayList<>();

    private static String LOG_TAG = "HomeFullemAdapter";
    ...
    public DetailSuggestAdapter(Context context) {
        this.context = context;
        mRecyclerViewItems = new ArrayList<>();
    }

    public void adddata(List<Item_collections> data) {
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        holder.image_video_thumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myClickListener.onSuggestItemClick(position, itemobj, mRecyclerViewItems, v);
            }
        });
