package com.tinyapps.oldsong.videostatus.Fragment;
...
import com.tinyapps.oldsong.videostatus.Activity.DetailActivity;
import com.tinyapps.oldsong.videostatus.Activity.MainActivity;
import com.tinyapps.oldsong.videostatus.Activity.RequestVideoActivity;
import com.tinyapps.oldsong.videostatus.Adapter.HomeCatWiseAdapter;
import com.tinyapps.oldsong.videostatus.Adapter.HomeCatlistAdapter;
import com.tinyapps.oldsong.videostatus.Adapter.HomeLatestAdapter;
import com.tinyapps.oldsong.videostatus.Adapter.HomeTrendingAdapter;
import com.tinyapps.oldsong.videostatus.ConnectionDetector;
import com.tinyapps.oldsong.videostatus.Constant;
import com.tinyapps.oldsong.videostatus.PullRefreshLayout;
import com.tinyapps.oldsong.videostatus.R;
import com.tinyapps.oldsong.videostatus.gettersetter.HomeCatData;
import com.tinyapps.oldsong.videostatus.gettersetter.HomeData;
import com.tinyapps.oldsong.videostatus.gettersetter.Item_collections;
import com.tinyapps.oldsong.videostatus.widgets.HorizontalInfiniteCycleViewPager;
 ...
 */
public class MainFragment extends Fragment implements HomeCatlistAdapter.MyClickListener, HomeCatWiseAdapter.MyClickListener, Constant.Callingafterads, HomeTrendingAdapter.MyClickListener, HomeLatestAdapter.MyClickListener {
                ...
                if (statusData.isStatus()) {
                    if (statusData.getIs_banner_shown().equals("true")) {
                        ...
                        Glide.with(getActivity())
                                .load(statusData.getBanner_background())
                    ...
                    if (getcategory.length() > 0) {
                        ...
                        homecatwisetadapter.adddata(catdatalisting, 1);
                    }
