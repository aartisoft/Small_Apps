package com.punjabivideostatus.latestsong.gettersetter;

public class Item_Favgetset extends Item_collections {
    ...
    public Item_Favgetset(String id, String video_name, String video_url, String video_image_thumb, String total_views, String is_type, String date, String cat_id, String category_name) {
        this.id = id;
