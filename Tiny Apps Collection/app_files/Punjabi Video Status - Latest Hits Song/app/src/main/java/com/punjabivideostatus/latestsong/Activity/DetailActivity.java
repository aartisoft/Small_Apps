...
import static com.punjabivideostatus.latestsong.Constant.SHARED_AUTOPLAY_SET;
...
//            nativeBannerAd.loadAd();
    ...
    private void showNotification(Context mContext, String title, String message, String filepath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Punjabivs_notification", importance);
