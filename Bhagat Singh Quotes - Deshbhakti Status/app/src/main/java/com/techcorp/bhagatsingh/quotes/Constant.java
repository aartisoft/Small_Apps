package com.techcorp.bhagatsingh.quotes;
...
public class Constant {
    ...
    public static final String notification_name = "BhagatSinghDeshbhakti_notification";
    public static final String NOTIFICATION_CHANNEL_ID = "10001_BhagatSinghDeshbhakti";


    public static final String SHARED_PREF = "ah_firebase_BhagatSinghDeshbhakti";
