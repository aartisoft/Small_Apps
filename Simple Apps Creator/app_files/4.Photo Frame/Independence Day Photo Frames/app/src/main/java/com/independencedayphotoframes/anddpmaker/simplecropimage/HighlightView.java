package com.independencedayphotoframes.anddpmaker.simplecropimage;
...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.ic_horizontal_resize);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.ic_vertical_resizing);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.ic_horizontal_resize);
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                mOutlinePaint.setColor(mContext.getResources().getColor(R.color.colorAccent));
