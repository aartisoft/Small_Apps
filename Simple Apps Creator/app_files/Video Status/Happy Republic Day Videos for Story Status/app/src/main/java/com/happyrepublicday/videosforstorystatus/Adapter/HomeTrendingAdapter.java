package com.happyrepublicday.videosforstorystatus.Adapter;
...
public class HomeTrendingAdapter extends RecyclerView.Adapter<HomeTrendingAdapter.DataObjectHolder> {
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder {
        ...
        ImageView image_trending;
        TextView video_name;

        public DataObjectHolder(View itemView) {
            super(itemView);
            image_trending = (ImageView) itemView.findViewById(R.id.image_trending);
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                .into(holder.image_trending);

        holder.video_name.setText(itemobj.getVideo_name()+"");

        holder.image_trending.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myClickListener.onTrendingItemClick(position, itemobj,mRecyclerViewItems,v);
            }
        });
