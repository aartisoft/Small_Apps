...
public class Constant {
    ...
    public static final String SHARED_PREF = "ah_firebase_HappyRepublicDay";
    ...
    public ArrayList<Item_collections> ConvertTOJSONObject(JSONArray getarray) throws JSONException {
        ArrayList<Item_collections> temp_array = new ArrayList<>();
