...
public class Item_images {
    ...
    public String toString() {
        return "ClassPojo [id = " + this.id + ", wall_name = " + this.wall_name + ", wallpaper_image = " + this.wallpaper_image + ", wallpaper_image_thumb = " + this.wallpaper_image_thumb +  ", total_views = " + this.total_views + ", total_download = " + this.total_download + ", date = " + this.date + ", cat_id = " + this.cat_id + ", wall_tags = " + this.wall_tags + ", category_name = " + this.category_name + "]";
    }
}
