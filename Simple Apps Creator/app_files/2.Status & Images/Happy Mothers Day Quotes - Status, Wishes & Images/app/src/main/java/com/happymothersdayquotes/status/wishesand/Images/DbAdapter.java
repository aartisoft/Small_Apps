...
public class DbAdapter {
    ...
    public static String dbname = "MothersDayQuotes_DB";
    public static String dbTable = "MothersDayQuotesFav";
    public static String dbTabledownload = "MothersDayQuotesDownload";
